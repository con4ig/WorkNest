...
export default function EmployeeList() {
    ...
    const handleRoleChange = async (userId, newRole) => {
        ...
        if (
            window.confirm(
                `Czy na pewno chcesz zmienić rolę tego użytkownika na "${getRoleLabel(newRole)}"?`,
            )
        ) {
            ...
            <div className="px-4 py-6 md:mx-auto md:max-w-7xl md:px-8 md:py-8">
                ...
                <div className="mb-6 grid grid-cols-3 gap-3 md:mb-8 md:gap-4">
                    ...
                    <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm md:p-4">
                        ...
                        <div className="mt-2 text-xl font-bold text-blue-600 md:text-2xl">
                    ...
                    <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm md:p-4">
                        ...
                        <div className="mt-2 text-xl font-bold text-purple-600 md:text-2xl">
                ...
                {/* Desktop Table */}
                <div className="hidden overflow-visible rounded-xl bg-white shadow-sm md:block">
                                                  ...
                                                  currentUser?._id ? (
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className="flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:border-emerald-600 hover:text-emerald-600"
                                                        >
                                                            Zmień rolę
                                                            <Icon.ChevronDown />
                                                        </button>
                                                        ...
                                                        {showRoleMenu ===
                                                            user._id && (
                                                            <div className="absolute right-0 top-full z-50 mt-2 w-48 rounded-lg border border-gray-200 bg-white shadow-2xl">
                                                                <div className="py-1">
                                                                    {[
                                                                        'employee',
                                                                        'hr',
                                                                        ...
                                                                        (
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className={`flex w-full items-center justify-between px-4 py-2.5 text-left text-sm transition-colors ${user.role === role ? 'cursor-not-allowed bg-gray-50 text-gray-400' : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700'}`}
                                                                            >
                                                                                <span>
                                                                                    {getRoleLabel(
                                                                                        role,
                                    ...
                                    <div className="mt-4 border-t pt-3">
                                        {changingRole === user._id ? (
                                            ...
                                            <button
                                                ...
                                                className="flex w-full items-center justify-between rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:border-emerald-600 hover:text-emerald-600"
                                            >
                                            ...
                                            <div className="mt-2 rounded-lg border border-gray-200 bg-gray-50 p-2">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`flex w-full items-center justify-between rounded px-3 py-2 text-sm transition-colors ${user.role === role ? 'cursor-not-allowed bg-white text-gray-400' : 'text-gray-700 hover:bg-white'}`}
                                                    >
                                                        <span>
                                                            {getRoleLabel(role)}
                                                        </span>
