...
const CalendarComponent = ({ leaves, onEventClick }) => {
    ...
    return (
        <div className="shadow-3xl h-[calc(100vh-280px)] min-h-[600px] w-full rounded-[2.5rem] border border-black/10 dark:border-white/10 bg-white dark:bg-zinc-900/30 p-4 backdrop-blur-2xl md:p-8 transition-colors duration-300
            [--calendar-text-main:theme(colors.zinc.900)]
            [--calendar-text-muted:theme(colors.zinc.400)]
            [--calendar-bg-today:rgba(0,0,0,0.03)]
            [--calendar-bg-view:rgba(0,0,0,0.02)]
            [--calendar-border:rgba(0,0,0,0.05)]
            [--calendar-off-range:rgba(0,0,0,0.02)]
            [--calendar-event-pending-bg:rgba(245,158,11,0.45)]
            [--calendar-event-pending-border:rgba(245,158,11,0.8)]
            [--calendar-event-approved-bg:rgba(16,185,129,0.45)]
            [--calendar-event-approved-border:rgba(16,185,129,0.8)]
            [--calendar-event-rejected-bg:rgba(244,63,94,0.45)]
            [--calendar-event-rejected-border:rgba(244,63,94,0.8)]
            dark:[--calendar-text-main:theme(colors.white)]
            dark:[--calendar-text-muted:theme(colors.zinc.500)]
            dark:[--calendar-bg-today:rgba(255,255,255,0.03)]
